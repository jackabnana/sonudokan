...
class ProductCreateView(CreateView):
    model = models.Product
    fields = ["name", "sub_title", "description", "price", "discounted_from_price", "main_image", "image1",
    ...
    def form_valid(self, form):
        ...
        self.object.save()
        messages.success(
            self.request, f'{self.object.name} was successfully added to your brand.')
        return redirect(self.get_success_url())


class ProductEditView(UpdateView):
    model = models.Product
    fields = ["name", "description", "price", "discounted_from_price", "main_image", "image1",
              "image2", "image3", "image4", "in_stock", "sku", "brand", "category", ]
